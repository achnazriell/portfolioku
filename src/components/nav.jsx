    ...
    return (
        <>
            <nav className="backdrop-blur-md sticky top-0 z-50 hidden sm:flex items-center justify-between px-10 py-5 text-gray-800 dark:text-white">
                ...
                <ul className="lg:text-xl md:text-sm flex items-center fixed md:right-32 lg:right-96 gap-16 nav">
            ...
            <nav className="block sm:hidden">
                <button onClick={toggleMenu} className="fixed top-5 right-8 flex flex-col justify-center items-center gap-1 backdrop-blur-md z-50 h-4 w-4 rounded-full">
