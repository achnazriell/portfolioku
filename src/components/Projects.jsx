...
const Projects = () => {
  ...
  return (
    <section className="p-6 lg:p-8">
        ...
        <div className="flex justify-end items-center h-9 rotate-45 ml-1 space-x-0">
          ...
          <div className="gear-container">
            <svg
              ...
              className="w-10 lg:w-12  gear rotate-clockwise"
              viewBox="0 0 512 512"
            >
              <path
                fill="#00BFFF"
          ...
          <div className="gear-container mb-2 space-x-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-5 lg:w-6  gear rotate-counterclockwise"
              viewBox="0 0 512 512"
            >
              <path
                fill="#00BFFF"
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-7 lg:w-8  gear rotate-counterclockwise"
              viewBox="0 0 512 512"
            >
              <path
                fill="#00BFFF"
      ...
      <br />
      <br />
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-1 lg:gap-10 space-x-0  mx-2 lg:mx-10 lg:mb-60 mb-20">
        <div className="flex flex-col md:items-center lg:items-start max-w-[400px]">
          ...
          <div className="flex items-center justify-between w-full mt-2">
            ...
            <a href="https://github.com/Alter-Lexcy/Smart-Lab" className="lg:mr-4 mr-2">
          ...
          <p className="mb-2 text-xs font-poppins lg:text-sm text-gray-500 dark:text-gray-400 text-left ">
            SmartLab is a Learning Management System (LMS) designed to streamline the management of educational content,
            facilitate communication, and enhance learning experiences for both instructors and students. It offers
            features for course creation, student enrollment, and progress tracking, all within an intuitive and
        ...
        <div className="flex flex-col md:items-center lg:items-start max-w-[400px]">
          ...
          <p className="mb-2 text-xs font-poppins lg:text-sm text-gray-500 dark:text-gray-400 text-left">
            web comic project involves both back-end and front-end development. The back end, built with Laravel,
