...
const Sidebar = () => {
    return (
        <nav className="absolute mt-5 md:mt-5 lg:mt-20 pb-20 h-[50%]">
            <ul className="list-none lg:space-y-16 md:space-y-5 space-y-5 backdrop-blur-md h-full w-5 lg:w-10 flex flex-col justify-evenly items-center font-semibold text-xs md:text-xs lg:text-base">
