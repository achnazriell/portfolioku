...
const Sidebar = () => {
    return (
        <nav className="absolute mt-12 pb-20 h-[50%]">
            <ul className="list-none lg:space-y-20 space-y-7 backdrop-blur-md h-full w-10 flex flex-col justify-evenly items-center font-semibold text-xs lg:text-base">
