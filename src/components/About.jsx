            ...
            <div className="relative flex-1">
                <section className="flex-1 lg:p-6 lg:pt-8">
                    <h1 className="flex ml-14 lg:ml-36 space-x-3 font-bold">
                        <span className="text-4xl lg:text-5xl animate-fadeInUp">About</span>
                        <span className="text-4xl lg:text-5xl animate-fadeInUp">Me</span>
                    </h1>

                    <div className="lg:mt-3 mt-3 ml-14 lg:ml-36 flex">
                        {/* Wrap paragraph */}
                        <div className="flex-1">
                            <p ref={paragraphRef} className="font-poppins text-sm mr-4 lg:mr-52 lg:text-xl mb-20 text-gray-600 dark:text-gray-300 animate-fadeInLeft">
                        ...
                        <div className="relative bg-white text-white">
                            ...
                            <div className="absolute top-0 left-0 lg:mb-36 lg:mt-[-60px] lg:w-60 lg:h-80 bg-white opacity-100"></div>
                        </div>
                    </div>
                </section>
            </div>
