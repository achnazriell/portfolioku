        ...
        <div className="flex">
            ...
            <div className="relative flex-1">
                <section className="flex flex-col lg:flex-row lg:items-start lg:gap-12 lg:p-6 lg:pt-8">
                    ...
                    {/* Kontainer paragraf + gambar */}
                    <div className="flex flex-col lg:flex-row lg:items-center lg:ml-36 lg:mt-6 gap-10">
                        {/* Paragraf */}
                        <div className="flex-1 lg:max-w-2xl">
                            <p
                                ref={paragraphRef}
                                className="font-poppins text-xs lg:text-xl mb-8 text-gray-600 dark:text-gray-300 animate-fadeInLeft leading-relaxed"
                            >
