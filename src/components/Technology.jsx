        ...
        <section className="p-6 lg:p-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 mx-2 animate-fadeIn">
                <div className="flex flex-col items-start">
                    ...
                    <h4 className="font-semibold text-base mt-2">ReactJs</h4>
                ...
                <div className="flex flex-col items-start">
                    ...
                    <h4 className="font-semibold text-base mt-2">Laravel</h4>
                    <p className="h-2 lg:h-0 mb-16 text-xs lg:text-base text-gray-500 dark:text-gray-400 text-left">
                ...
                <div className="flex flex-col items-start">
                    ...
                    <h4 className="font-semibold text-base mt-2">Tailwind CSS</h4>
                    <p className="h-2 lg:h-0 mb-16 text-xs lg:text-base text-gray-500 dark:text-gray-400 text-left ">
                ...
                <div className="flex flex-col items-start">
                    ...
                    <h4 className="font-semibold text-base mt-2">C++</h4>
                    <p className="h-2 lg:h-0 mb-16 text-xs lg:text-base text-gray-500 dark:text-gray-400 text-left ">
                ...
                <div className="flex flex-col items-start">
                    ...
                    <h4 className="font-semibold text-base mt-2">HTML</h4>
                    <p className="h-2 lg:h-0 mb-16 text-xs lg:text-base text-gray-500 dark:text-gray-400 text-left ">
                ...
                <div className="flex flex-col items-start">
                    ...
                    <h4 className="font-semibold text-base mt-2">CSS</h4>
                    <p className="h-2 lg:h-0 mb-16 text-xs lg:text-base text-gray-500 dark:text-gray-400 text-left ">
                ...
                <div className="flex flex-col items-start">
                    ...
                    <h4 className="font-semibold text-base mt-2">JavaScript</h4>
                    <p className="h-2 lg:h-0 mb-16 text-xs lg:text-base text-gray-500 dark:text-gray-400 text-left ">
                ...
                <div className="flex flex-col items-start">
                    ...
                    <h4 className="font-semibold text-base mt-2">PHP</h4>
                    <p className="h-2 lg:h-0 mb-16 text-xs lg:text-base text-gray-500 dark:text-gray-400 text-left ">
            ...
            <div className="flex justify-center mt-8 animate-fadeIn">
                <div className="flex flex-col items-center ">
                    ...
                    <h4 className="font-semibold text-base mt-2">Bootstrap</h4>
                    <p className="h-2 lg:h-0 mb-16 text-xs lg:text-base text-gray-500 dark:text-gray-400 text-left">
